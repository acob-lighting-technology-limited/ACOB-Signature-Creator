...
interface CreateNotificationParams {
  userId: string
  type: 'task_assigned' | 'task_updated' | 'task_completed' | 'mention' | 'feedback' | 'asset_assigned' | 'approval_request' | 'approval_granted' | 'system' | 'announcement'
...
export async function notifyAssetAssigned(params: {
  ...
  return createNotification({
    ...
    message: `${assetName} (${assetCode}) has been assigned to you`,
    priority: 'normal',
    linkUrl: `/assets`,
    actorId: params.assignedBy,
    entityType: 'asset',
